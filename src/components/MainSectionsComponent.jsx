      ...
      <div className='mt-2 flex flex-col gap-8 px-[6%]'>
          <main className='flex flex-col gap-6 justify-center md:gap-16'>
            ...
            <section className='relative w-full h-auto'>
              <img className='w-full h-auto min-h-[20rem] max-h-[35rem] object-cover object-right' src={window.innerWidth <= 700 ? 'images/pexels1-small2.jpg' : 'images/pexels1.jpg'} alt="Picture of a classroom" width={1280} height={853} />
