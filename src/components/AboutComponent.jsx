...
export default function AboutComponent() {
  return (
    <>
      <main id='main' className='mt-2 flex flex-col gap-6 lg:gap-16 px-[6%] text-blue-900'>
        <section className='flex flex-col gap-6 lg:flex-row'>
          ...
          <div className='w-full lg:w-1/2'>
            <img className='w-full h-full object-cover object-left' src="images/seplaying2.jpg" alt="2 children playing together at the West Covina Daycare" width={480} height={478} />
          </div>
        </section>
